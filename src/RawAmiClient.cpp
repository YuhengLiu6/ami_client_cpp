...
namespace ami {
    ...
    bool SslSocket::connect_using_pem_files(const std::string& host, const std::string& port)
    {
        ...
        try {
            ...
            spdlog::info("ssl: handshake performed successfully");
        }
        ...
        boost::asio::ssl::verify_context& ctx)
    {
        ...
        spdlog::debug("Verifying certificate: {}", subject_name);
    ...
    bool RawAmiClient::connect(const std::string& host,
        ...
        return connect(host, port, logErrorOnRetries, autoFlush, "", "");
    }
    ...
    long long RawAmiClient::getNow() const {
